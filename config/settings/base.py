...
#         'NAME': BASE_DIR / 'db.sqlite3',  # This creates a file called db.sqlite3 in your project directory
#     }
# }
...
# STATICFILES_DIRS = [str(BASE_DIR / "my_awesome_project" / "static")]
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
